...
function PatientPortal({ currentPatient }) {
    ...
    <div className="split-view-container" style={{ maxWidth: '1100px', margin: '0 auto' }}>
      <div className="right-column" style={{ flex: 1.5 }}>
        ...
        {currentPatient.visits.length === 0 ?
         <p style={{ color: 'gray' }}>No history records yet.</p> :
      ...
      <div className="right-column" style={{ flex: 1 }}>
        ...
        <form onSubmit={handleBook}>
          <div className="form-group">
            <input type="date" className="form-field" value={appDate} onChange={(e) => setAppDate(e.target.value)} required />
          </div>
          <div className="form-group">
            <textarea className="form-field" placeholder="Reason..." value={reason} onChange={(e) => setReason(e.target.value)} style={{ height: '70px', resize: 'none' }} />
